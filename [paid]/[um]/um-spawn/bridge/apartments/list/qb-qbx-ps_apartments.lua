...
if um.property.apartments.script ~= 'qb' and um.property.apartments.script ~= 'qbx' and um.property.apartments.script ~= 'ps' then return end

Debug('qb_apartments | qbx_apartments | ps_housing list ready', 'debug')
...
UM_apartments = {
    ...
    ['MorningwoodBlvd'] = {
        ...
        image = './properties/MorningwoodBlvd.png',
        features = {
            beds = '2 bd',
            bath = '2 ba',
            sqft = '1,800 sqft'
    ...
    ['IntegrityWay'] = {
        ...
        text = 'Integrity Way',
        image = './properties/IntegrityWay.png',
        features = {
            beds = 'Studio',
            bath = '1 ba',
            sqft = '1,100 sqft'
    ...
    ['TinselTowers'] = {
        ...
        text = 'Tinsel Towers',
        image = './properties/TinselTowers.png',
        features = {
            beds = '1 bd',
            bath = '1 ba',
            sqft = '2,200 sqft'
    ...
    ['FantasticPlaza'] = {
        ...
        image = './properties/FantasticPlaza.png',
        features = {
            beds = 'Studio',
            bath = '1 ba',
            sqft = '800 sqft'
