...
```
    ...
    ['leo_gps']                         = {['name'] = 'leo_gps',                           ['label'] = 'LEO GPS',                   ['weight'] = 200,         ['type'] = 'item',         ['image'] = 'leo-gps.png',                 ['unique'] = true,          ['useable'] = true,      ['shouldClose'] = true,      ['combinable'] = nil,   ['description'] = 'Show your gps location to others'},
    ...
    ['fp_scanner']                      = {['name'] = 'fp_scanner',                        ['label'] = 'Fingerprint Scanner',       ['weight'] = 300,          ['type'] = 'item',         ['image'] = 'fp_scanner.png',              ['unique'] = true,          ['useable'] = true,      ['shouldClose'] = true,      ['combinable'] = nil,   ['description'] = 'Take fingerprints from civilians'},
    ['fp_document']                     = {['name'] = 'fp_document',                       ['label'] = 'Fingerprint Document',      ['weight'] = 300,          ['type'] = 'item',         ['image'] = 'fp_document.png',             ['unique'] = true,          ['useable'] = true,      ['shouldClose'] = true,      ['combinable'] = nil,   ['description'] = 'Document with fingerprint'},
```
...
```
    ...
    ["fp_scanner"] = { label = "Fingerprint Scanner", weight = 200, stack = false, close = true, description = "Take fingerprints from civilians", client = {image = "fp_scanner.png",}},
    ["fp_document"] = { label = "Fingerprint Document", weight = 200, stack = false, close = true, description = "Document with fingerprint", client = {image = "fp_document.png",}},
```
...
```
        ...
        case "fp_document":
            ...
            <p><strong>Name: </strong><span>${itemData.info.name}</span></p>
            <p><strong>DOB: </strong><span>${itemData.info.dob}</span></p>
            <p><strong>Gender: </strong><span>${itemData.info.gender}</span></p>
            <p><strong>Country: </strong><span>${itemData.info.country}</span></p>
            <p><strong>Fingerprint ID: </strong><span>${itemData.info.fid}</span></p>`;
```
