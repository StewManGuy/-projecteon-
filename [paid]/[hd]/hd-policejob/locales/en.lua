local Translations = {
    ...
    objmenu = {
        ...
        spawn_radar = 'Spawn Radar',
        spawn_spike = 'Spawn Spikestrip'
    },
    email = {
    ...
    radar = {
        title = 'Radar',
        r_head = 'Speed Limit',
        r_limit = 'What is the speed limit?',
        r_ppu = 'Price per unit ?',
        r_setto = 'Speed limit set to : %{limit}',
        r_finereceived = 'You were fined $ %{price} for speeding %{speed} KMph',
        r_flagged = 'Speed camera # %{radarnr} - Marked vehicle'
    },
    fingerscan = {
        title = 'Fingerprint'
    }
