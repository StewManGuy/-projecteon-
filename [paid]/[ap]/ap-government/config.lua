Config = {
	...
	Phone = {GKSPhone = false, QBPhone = true, QuasarPhone = false, QSPRO = false, HighPhone = false, LBPhone = false, Custom = false}, -- Set to the phone you use to true, if you do not have one of these phones then set Custom to true and edit the function in webhooks.lua.
