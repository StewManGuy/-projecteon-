...
Config.InputSystem = "framework" -- default (gta v), ox_lib or framework
Config.MenuSystem = "framework" -- ox_lib or framework
Config.NotificationSystem = "framework" -- default (gta v), ox_lib or framework

Config.PricePerSecond = 3
